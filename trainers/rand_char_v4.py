...
def perturb_sentence(sentence, alphabet, alphabet_distribution, q=5, custom_char="§"):
    ...
    nr_insertions = int(nr_perturbations / 2)
    nr_deletions = int(nr_perturbations / 4)
...
class RandCharV4Trainer:
    def __init__(self, model_wrapper: ModelWrapper, alphabet, alphabet_distribution, device, args):
        ...
        self.alphabet_distribution = alphabet_distribution
        self.q = args.q
    ...
    def train(self, train_loader, val_loader, save_path, num_epochs):
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, batch in pbar:
                # Perturb inputs
                inputs = [perturb_sentence(sentence, self.alphabet, self.alphabet_distribution, q=self.q) for sentence in batch['sentence']]
