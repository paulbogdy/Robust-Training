...
from trainers import AdvEmbTrainer, RandCharTrainer, RandCharV2Trainer, RandCharV3Trainer, BaseTrainer
import torch
import random
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--training_method', 
        type=str, 
        choices=['adv_emb', 'rand_char', 'rand_char_v2', 'rand_char_v3', 'base'], 
        required=True,
